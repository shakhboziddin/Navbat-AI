...
export const GlassEffect: React.FC<GlassEffectProps> = ({
  ...
  return href ? (
    <a href={href} target={target} rel="noopener noreferrer" className="block" onClick={onClick}>
      {content}
    </a>
  ) : (
    content
...
export const GlassButton: React.FC<{ children: React.ReactNode; href?: string; onClick?: () => void; className?: string }> = ({
  ...
  >
    <div
      className="transition-all duration-700 hover:scale-95 flex items-center justify-center gap-2"
      style={{
        transitionTimingFunction: "cubic-bezier(0.175, 0.885, 0.32, 2.2)",
      }}
    >
